...
namespace Provider.Models
{
    public class ReadOnlyXmlMembershipProvider : MembershipProvider
    {
        ...
        public override MembershipUserCollection GetAllUsers(int pageIndex, int pageSize, out int totalRecords) {
            ...
            foreach (KeyValuePair<string, MembershipUser> pair in this._users) {
                userCollection.Add(pair.Value);
            }
        ...
        private void ReadMembershipDataStore() {
            lock (this) {
                if (this._users == null) {
                    this._users = new Dictionary<string, MembershipUser>(16, StringComparer.InvariantCultureIgnoreCase);
                    ...
                    foreach (XmlNode node in nodes) {
                        ...
                        this._users.Add(user.UserName, user);
                    }
                }
            }
        }
